...
- [ ] Skills: Possesses foundational knowledge in Data Structures and Algorithms (DSA) and is learning to apply it to production systems
- [ ] Growth: Focused on moving toward L4 (mid-level) by taking on more ambiguity and technical ownership
...
- [ ] Project ownership: Leads features end-to-end, managing project scope, and collaborating with stakeholders
...
- [ ] Behavioral shift: Moves from task-based work (L4) to owning outcomes, planning, and mentoring (L5)
- [ ] Collaboration: Acts as a liaison between engineering and non-engineering teams (product, design) to ensure project success
